...
class DGrabViewController: UIViewController, UIScrollViewDelegate {
    ...
    //pageView
    lazy var allVC = DGrabListViewController.controllerWith(listType: .all)
    lazy var phoneVC = DGrabListViewController.controllerWith(listType: .phone)
    lazy var webVC = DGrabListViewController.controllerWith(listType: .web)
