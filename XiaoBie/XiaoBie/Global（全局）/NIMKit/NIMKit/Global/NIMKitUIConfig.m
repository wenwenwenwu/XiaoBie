...
- (NSArray *)allowedMediaItems
{
    NSMutableArray *tempArr = [NSMutableArray array];
    
    NIMMediaItem *photo = [NIMMediaItem item:@"onTapMediaItemPicture:"
                                   normalImage:[UIImage imageNamed:@"bk_media_picture_normal"]
                                 selectedImage:[UIImage imageNamed:@"bk_media_picture_nomal_pressed"]
                                         title:@"相册"];
    NIMMediaItem *photograph = [NIMMediaItem item:@"onTapMediaItemShoot:"
                                      normalImage:[UIImage imageNamed:@"bk_media_shoot_normal"]
                                    selectedImage:[UIImage imageNamed:@"bk_media_shoot_pressed"]
                                            title:@"拍摄"];
    
    NIMMediaItem *voice = [NIMMediaItem item:@"onTapMediaItemAudioChat:"
    ...
    [tempArr addObject:photograph];

    if ([self.type isEqualToString:@"2"]){
        [tempArr addObject:voice];
    }else if ([self.type isEqualToString:@"3"]){
        [tempArr addObject:voice];
        [tempArr addObject:videoChat];
    }
