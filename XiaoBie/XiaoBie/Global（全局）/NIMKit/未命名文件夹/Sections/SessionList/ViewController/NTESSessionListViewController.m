...
- (void)onSelectedRecent:(NIMRecentSession *)recent atIndexPath:(NSIndexPath *)indexPath{
    //fixed by dd 点击聊天cell?
    DDChatSessionViewController *vc = [[DDChatSessionViewController alloc] initWithSession:recent.session];
...
- (UIView*)titleView:(NSString*)userID{
    ...
    //fixed by dd conversionListView的title
    self.titleLabel.text =  @"最近联系人";
...
//    [subLabel sizeToFit];
    ...
    titleView.width  = _titleLabel.width;
