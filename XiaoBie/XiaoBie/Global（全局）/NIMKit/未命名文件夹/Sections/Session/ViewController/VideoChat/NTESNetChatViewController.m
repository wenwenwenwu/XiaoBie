...
- (void)startByCaller{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        //fixed by dd
        NSString *serviceid = (NSString *)[[NSUserDefaults standardUserDefaults] objectForKey:@"SERVICEID"];
        option.extendMessage = serviceid;
...
//        option.apnsSound = @"video_chat_tip_receiver.aac";
        option.apnsSound = @"iPhoneRing.mp3";
