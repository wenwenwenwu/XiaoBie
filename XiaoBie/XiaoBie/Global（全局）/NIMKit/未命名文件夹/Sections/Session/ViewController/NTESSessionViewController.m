...
//    self.navigationController.navigationBar.titleTextAttributes = dict;
    //fixed by dd 改变左上忧伤的item
//    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 40, 40)];
//    [btn setImage:[UIImage imageNamed:@"back"] forState:(normal)];
//    
//    UIBarButtonItem *leftBtn = [[UIBarButtonItem alloc]initWithCustomView:btn];
//    
//    self.navigationController.navigationItem.leftBarButtonItem = leftBtn;
//    self.navigationController.navigationBar.backIndicatorImage = [UIImage imageNamed:@"Delete"];
//    self.navigationController.navigationBar.backIndicatorTransitionMaskImage = [UIImage imageNamed:@"Delete"];
}
